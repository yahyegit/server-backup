...
<label>Company name</label><br>
 <input type='text' placeholder='username' name='username' value='".mysqli_result_(mysqli_query_("SELECT `username` FROM `settings` LIMIT 1"), 0)."' error_empty_msg='username is required !' required> <p id='error_line' class=' hide'></p> </td></tr></table>
