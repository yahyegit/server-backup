...
<div id="register_feadback" class="th_new" style="margin-bottom: 27px;float: right;width: 72%;box-shadow: rgba(46, 61, 73, 0.2) 5px 5px 25px 0px !impo
rtant;font-weight: normal !important;color: rgba(128, 80, 162, 0.77);font-family: Arial, Helvetica, sans-serif;font-size: 18px;padding: 8px;/* margin:
 0px; */ background: #fff;">
 

   <a href="#" onclick="$('.th_new').hide();" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-icon-only ui-dialog-titlebar-close" 
role="button" aria-disabled="false" title="close" style="
   float: right;
   height: 23px;
"><span class="ui-button-icon-primary ui-icon ui-icon-closethick">close</span><p id="error_line" class="hide"></p><span class="ui-button-text">close</
span></a>
...
" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-primary" onclick="window.location.href = 'http://forex.kunkeen.cash';"
 role="button" aria-disabled="false" title="let's try"><span class="ui-button-icon-primary ui-icon ui-icon"></span><span class="ui-button-text"> Try n
ow</span></a>
