...
<table class='table dataTable'  table_file='php_files/pages/server-side-tables/transactions_history.php'  other_query=\"$other_query_\" >
  <thead><tr><th> Name </th> <th> cash in </th> <th> cash out </th> <th>  balance </th> <th> dollar in </th> <th> dollar out </th> <th>  balance </th> <th>Date</th><th>Description</th> <th  class='hide_for_print' >Action</th>  </tr></thead>
  <tbody>
