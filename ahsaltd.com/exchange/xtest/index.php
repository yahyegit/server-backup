...
<link checkads="1" rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/animate.css/4.1.1/animate.min.css">
...
div[aria-describedby="transForm"] .ui-dialog-buttonset button {
    font-size: 20px;
    font-weight: bold !important;
}


  .table tr:hover td :not(#transForm .table tr td)  {
  background:#4E5066;
  color:#FFFFFF;
