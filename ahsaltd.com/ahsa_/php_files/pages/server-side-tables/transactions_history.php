	     ...
	     while($aRow = mysqli_fetch_assoc_($rResult))
			{
				...
				$row[] = '<span >'.number_format($aRow["cash_in"],2).' ksh</span>';
				$row[] = '<span   >'.number_format($aRow["cash_out"],2).'ksh</span>';
				$row[] = '<span class="'.toggle_debt_color($aRow["cash_balance"]).'" >'.number_format($aRow["cash_balance"],2).' ksh</span>';
