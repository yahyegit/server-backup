...
<button class='change ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-primary'  onclick=\"request_template('',{customer_info:'{$cust_info['customer_name']}\' ".number_format($cust_info['current_ksh_balance'],2)." ksh and $".number_format($cust_info['current_dollar_balance'],2)." \' {$cust_info['mobile']}'},'pages/forms/make_transction_form_page.php');\"  role='button' aria-disabled='false' style='font-size: 11px;'><span class='ui-button-icon-primary ui-icon ui-icon-plus'></span><span class='ui-button-text'>Add trans</span></button> 
