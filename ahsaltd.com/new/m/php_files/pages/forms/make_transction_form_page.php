...
<tr>
     ...
     <td> <input type='text' autocomplete='off'  name='customer_name'  onkeyup='calc_balance()' placeholder=\"name \" autofocus onchange='customer_info($(this).val());' onload='customer_info($(this).val());' $disabled_input  value=\"{$data['customer_info']}\" required   error_empty_msg=' customer name is required !' > </td>
       <tr>
 <td>   <input type='text' name='cash_in' placeholder=\"Cash In\" value='{$trans_data['cash_in']}'    format_comma='true' onkeyup='calc_balance()' onchange='calc_balance()'   ><span class=\"currency\">Ksh</span> </td> </tr>

 <tr> 
<td>
    <input type='text' name='cash_out' placeholder=\"Cash Out\" value='{$trans_data['cash_out']}'    format_comma='true' onkeyup='calc_balance()' onchange='calc_balance()'   ><span class=\"currency\">Ksh</span> </td>  </tr>
     <tr>  
    <td> <label>Cash balance: </label> <b id=\"cash_balance\" cash_balance='0'> 0  </b> </td> </tr>
  <tr> 

    <td> <span class=\"currency\">$</span><input type='text' name='dollar_in' placeholder=\"Dollar In\" value='{$trans_data['dollar_in']}'    format_comma='true' onkeyup='calc_balance()' onchange='calc_balance()'   > </td></tr>
  <tr> 
<td>
  ...
  <tr>
     <td><label  >Dollar balance:</label> <b id=\"dollar_balance\" dollar_balance=\"0\"> 0 </b></td></tr>
<tr>
...
<table class='table' >
<tr><td>
    <input type='text' name='mobile' $disabled_input placeholder=\"mobile is option\" value='{$data['mobile']}'    placeholder=\"mobile\"> </td></tr> 

   <tr><td>  <textarea id='description' name='description' placeholder='Description is optional' style='border: 2px groove;border-radius: 0.5em;' ></textarea> </td></tr> 
</table>

    <div class='form_footer_btns'>
    <a href='#'  style='margin-left: 14px;' file_name='php_files/clasess/transactions_class.php' class='submit_btn change ui-button primary_button ui-widget ui-state-default ui-corner-all ui-button-text-icon-primary' role='button' aria-disabled='false'><span class='ui-button-icon-primary ui-icon'></span><span class='ui-button-text'> ".((is_numeric(trim($data['id'])))?'edit':'add')."  </span></a>
