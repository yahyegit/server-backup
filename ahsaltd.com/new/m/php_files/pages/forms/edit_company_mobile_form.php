...
<table class='table'><tr>
 ...
 <td>	<input type='hidden' name='crf_code'  value='".get_unique_code()."'> <input type='number' placeholder='company mobile' name='mobile' value='".mysqli_result_(mysqli_query_("SELECT `mobile` FROM `settings` LIMIT 1"), 0)."' >  </td></tr></table>
