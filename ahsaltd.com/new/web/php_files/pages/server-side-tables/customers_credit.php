 ...
 <?php
   ...
   require '../../clasess/extra_functions.php';
	...
	$aColumns = explode(",",'customer_id,customer_name,mobile,current_ksh_balance,current_dollar_balance');  
	$sIndexColumn =  'customer_id';  
 	 	$other_query = " customer_name !='' and current_ksh_balance NOT LIKE '-%' OR current_dollar_balance NOT LIKE '-%' ";  
