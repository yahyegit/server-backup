...
<div class="underline pl"> '.$cust_name.' </div>
<div class="underline pl"> <span class="plc">In:</span> '.'<span >'.number_format($aRow["cash_in"],2).' ksh</span>'.' |   <span class="plc">Out:</span>  '.'<span   >'.number_format($aRow["cash_out"],2).'ksh</span>'.' </div>
<div class="underline pl">  <span class="plc"> new balance:</span> '.'<span class="'.toggle_debt_color($aRow["cash_balance"]).'" >'.number_format($aRow["cash_balance"],2).' ksh</span>'.' </div>
<div class="underline pl">   <span class="plc"> In:</span> '.'<span >$'.number_format($aRow["dollar_in"],2).'</span>'.' | <span class="plc"> Out:</span> '.'<span   >$'.number_format($aRow["dollar_out"],2).'</span>'.'  </div>
<div class="underline pl">  <span class="plc"> new balance:</span>  '.'<span class="'.toggle_debt_color($aRow["dollar_balance"]).'" >$'.number_format($aRow["dollar_balance"],2).'</span>'.' </div>
<div class="underline pl">   <span class="plc">Date:</span> '.$trans_date.' </div>
<div class="underline pl"><span class="plc">Description:</span> '.$aRow['description'].' 
</div>
