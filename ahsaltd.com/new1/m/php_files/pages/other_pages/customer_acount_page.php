...
$rt =  "<div class='  trans_panel_box dashboard_panel ' style='margin-top:0px;'       > ".'<div class="underline pl"> '."{$cust_info['customer_name']} ({$cust_info['mobile']})
...
<div class="underline pl">  <span class="plc"  >Balance:</span> '.'<b class='.toggle_debt_color($cust_info['current_ksh_balance']).'>'.number_format($cust_info['current_ksh_balance'],2).' ksh</b>  <b style="padding:3px">|</b>   <b class='.toggle_debt_color($cust_info['current_dollar_balance']).'>$'.number_format($cust_info['current_dollar_balance'],2).'</b>'.' </div>
