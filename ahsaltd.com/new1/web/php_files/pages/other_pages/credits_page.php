...
function get_credit_customers(){
 $currents = get_current_totals();
	...
	return "<h3 class='title_'>(". number_format(mysqli_result_(mysqli_query_("select count(customer_id) from customers where  customer_name !='' and current_ksh_balance NOT LIKE '-%' OR current_dollar_balance NOT LIKE '-%'  and delete_status!='1'"),0)).") customers  </h3>
