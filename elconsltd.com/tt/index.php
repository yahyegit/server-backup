...
<div id="addTabs">
  ...
  <div id="add_tabs_">
					...
					<ul class="ul" id=""> 
					    ...
					    <li> <label> Driver license No :  </label><input type="text" collmName="driverLicenseNo	" id="driverLicenseNo" class="driverLicenseNo  trucks expense  " error_msg="" required_error="Please Enter the license NO !"  />  </li>
