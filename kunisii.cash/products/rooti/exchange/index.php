...
<div id="containter" class="coppyRight" style=" clear: both; width: 580px; font: bold 15px italic; text-align: center; color: #fff; margin-left: 18%; padding: 10px; background: #000000;border-radius: 7px;-moz-border-radius: 7px;-webkit-border-radius: 7px;box-shadow: 10px 10px 15px #A0A0A0;-moz-box-shadow: 5px 5px 15px #A0A0A0;-webkit-box-shadow: 5px 5px 15px #A0A0A0; /* height: 600px; */ /* overflow-x: auto; */}* {margin: 0px;padding: 0px;list-style-type: none; ;margin-top: 0; margin-bottom : 1;"> <a href="#" style="color: #fff;"> Developed by: Yahye  (+25261-373-1436) </a> </div>
