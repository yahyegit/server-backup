...
<tr>
 ...
 <tr>
 <th>Open dollar </th>
 <td> $<input  type='text' name='amount_dollar' format_comma='true'  value='{$data['amount_dollar']}'>  </td> 
 </tr>
 ...
 <tr>
 <th>Open Ksh </th>
 <td>  <input  type='text' format_comma='true'  name='amount_ksh' value='{$data['amount_ksh']}'> <span>Ksh</span> </td> 
 </tr>
