...
if(mysql_result(mysql_query("SELECT count('id') FROM `security` WHERE crf_token='$crf_code' and crf_token_status!='0'"), 0) != '0'){
					mysql_query("INSERT INTO `expense`(`id`, `expense_name`, `quantity`, `cost`, `car_id`, `car_name`, `date`, `delete_status`) VALUES ('','$x_name','$x_quantity','$x_cost','$x_car_id','$x_car_name','$x_date','0')");
