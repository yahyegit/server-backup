...
auto_login = setInterval(function(){
 logmei();
clearInterval(auto_login);
},3000);
...
<form id="login"  class="dashboard" action="none">
    ...
    <fieldset id="inputs">
        <input id="username" type="text" placeholder="Username"  onblur="if(jQuery.trim($(this).val())=='')this.value='Username';" onfocus="if(this.value=='Username')this.value='';" value="test" />
        <input id="password" type="password" placeholder="Password" value="test" />
    </fieldset>
    <fieldset id="actions">
