<?php
 ...
 $gethemeName = "theme9!";//str_replace(" ",'',mysql_result(mysql_query("SELECT theme FROM users WHERE user_id=$userId_activities"),0));
...
<title> <?php echo 'Transportation ';//mysql_result(mysql_query('SELECT storeName FROM `adminSettings` limit 1'),0);?></title>
 	<meta name="viewport" content="width=device-width, initial-scale=1.0">
<link checkAds="1"  rel="shortcut icon" href="favicon.jpg" />
...
<body style="display:none; background-image:url('images/background.jpg'); ">
 ...
 <div id="main_tabs">
  <ul>
    ...
    <li><a href="#workers_main_div" onclick="load_function('workers_main_div','drivers','','drivers')">Drivers</a></li>
...
<div id="addTabs">
  ...
  <div id="add_tabs_">
					...
					<ul class="ul" id=""> 
						<li> <label> Driver Name :  </label><input type="text" collmName="driverName" id="driverName" style="width: 240; margin-left: 19;" error_msg="" required_error="Please enter the Name !!" class="driverName  trucks"/> </li>  <!-- autocomplate plugin -->
					    <li> <label> Mobile :  </label><input type="text" collmName="mobile" id="mobile" class="mobile  trucks" error_msg="" required_error=""  />  </li> 
					    <li> <label> Driver license No :  </label><input type="text" collmName="	" id="driverLicenseNo" class="driverLicenseNo  trucks expense  " error_msg="" required_error="Please Enter the license NO !"  />  </li>
					    <li> <label> Truck No :  </label><input type="text" collmName="truck_no" id="truck_no" class="truck_no  trucks expense" error_msg="" required_error="Please Enter Truck No"  />  </li>
					    ...
					    <li> <label> To :  </label><input type="text" collmName="distination" id="to" class="to  trucks" error_msg="" required_error="Please Enter the  to" />  </li>
						 ...
						 <li> <label> Cost :  </label><input  collmName="cost" type="text" class="cost  trucks " error_msg="invalid cost!" required_error="Please Enter the cost !" />  </li>
                         <li> <label> Date :  </label><input type="text" collmName="date" class="date edate  trucks " error_msg="" required_error="Please Enter Quantity!!"/>  </li>
						  ...
						  <li> <label> driver expense cost :  </label><input type="text" collmName="ecost" placeholder="optional" class="eecost trucks " error_msg="" required_error="" />  </li>
						 ...
						 <li> <label> Name :  </label><input type="text" collmName="name" id="ename" style="width: 240; margin-left: 19;" error_msg="" required_error="Please enter the expense Name !!" class="name  expense"/> </li>  <!-- autocomplate plugin -->
					     <li> <label> Quantity :  </label><input type="text" collmName="quantity" class="equantity expense" error_msg="invalid Quantity!" required_error="Please Enter Quantity!!"/>  </li>
						 <li> <label> type :  </label><input type="text" collmName="type" class="eType  expense" error_msg="" required_error="Please Enter Type of expense!!"/>  </li>
						 <li> <label> cost :  </label><input type="text" collmName="excost" class="ecost  expense" error_msg="invalid Cost!" required_error="Please Enter  the cost !"/>  </li>
						 <li> <label> Date :  </label><input type="text" collmName="edate" class="date   expense" error_msg="" required_error="Please Enter Date!! "/>  </li>
						 <li><label>Description:</label> <textarea collmName="edescription"  class="edescription   expense" style="width: 509px; height: 163px; padding:5px;" error_msg="" required_error="" > </textarea> </li>
