...
function company_exist($data){
 ...
 global $connection;
 global $myDB;
 $connection->select_db("lacagtayda_service");
...
function service_update($data){
 ...
 $connection->select_db("lacagtayda_service");
  ...
  foreach($data as $key => $value) {
         ...
         //   echo "update customers set ".sanitize($key)." ='".sanitize($value)."' where company_name='".str_replace('lacagtayda_', '',$myDB)."' ";
                mysqli_query_("update customers set ".sanitize($key)." ='".sanitize($value)."' where company_name='".str_replace('lacagtayda_', '',$myDB)."' ");
            }
