 ...
 <?php
	...
	$aColumns = explode(",",'id,full_name,status,username,password,type,current_remaining_limit');
	$sIndexColumn =  'id';  
        ...
        // all queries is static 
	     while($aRow = mysqli_fetch_assoc_($rResult))
          ...
          $m_ .= "<p>  <label class='show_ float_label'>password:</label> ***** </p>";
		   ...
		   $m_ .= "<p> <label class='show_ float_label'>Remaining limits:</label> $".number_format($aRow['current_remaining_limit'],2)." 
