...
global $current_user;
    ...
    $your_rem_limit = "  <table class='table' style='
    width: 50%;  
    margin-top: 20px;
    /* margin-left: 0px; */
...
<tbody>
  <tr> <td style='
    background: #fafbfc;
'> <p class=' underline '   style=\"margin-top: 4px;\"   > <label class=\"show_ float_label\" >  current remaining limit is</label> <b class=' '>$".
number_format( $current_limit,2)."  </b>  </p> </tr></tbody> </table>";
