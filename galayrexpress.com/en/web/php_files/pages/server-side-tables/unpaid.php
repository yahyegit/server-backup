 ...
 <?php
	...
	$aColumns = explode(",",'sent_date,commission,paid_date,id,status,amount,sender_id_no,pay_to_id,sender_name,sender_mobile,pay_to_name,pay_to_mobile,description,user_id');
