...
<td> <p><label class='float_label show_'> item</label>  $item_name </p>  

<p><label class='float_label show_'> remaining </label> $remainings </p>


<p><label class='float_label show_'> price </label> $price </p>
...
\" class=\"ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-primary\" onclick=\"r_page('',{id:{$aRow['id']} },'pages/forms/receive_items_form.php');\"  role=\"button\" aria-disabled=\"false\"><span class=\"ui-button-icon-primary ui-icon ui-icon-plus\"></span><span class=\"ui-button-text\"> alaab kudar </span></button>
