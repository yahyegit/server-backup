...
//      <th> item  </th> <th>  quantity </th><th> price </th>  <th> balance </th>  <th> action </th> 
  ...
  $ot =  "    <table class='table_order' style='width:auto'  >  <thead> <tr> <th>  item </th> <th>  tirada <i>(quantity)</i> </th> <th> price </th>   </tr>  </thead>   <tbody> ";
  $total_price = 0;
  $total_balance = 0;
...
$hide_ = (trim($customer_name) !='' && !preg_match('/customer_id/',$other_query))?"":"style='display:none;'";
	$ot .=  "</tbody></table> <table class='table_order  ' style='width:auto'>   <tbody> ";
     ...
     $ot .=  "<tr> <td>  <span class='gray' style='margin-left: '   >  total price </span>  $ccc".number_format($total_price,2)."   </td>     </tr>
...
<tr> <td>  <span class='gray'  > date </span>  ".date('d-M-Y',strtotime($o_date))."  </td></tr>
