...
function realTimeBl(){
			...
			$('input[name="price"]').each(function(){
                    ...
                    price_t =  quantity*clean($(this).closest('tr').find("input[name='price']:first").attr('price'));
			...
			$(this).closest('tr').find("input[name='price']:first").attr('type','text').val(CommaFormattedN(price_t));
