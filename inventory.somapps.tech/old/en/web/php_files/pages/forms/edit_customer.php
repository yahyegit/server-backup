...
<p class='title_' style='".((!empty($customer_id))?'display:none;':'')."'> macmiil ayaad system ka kudaraysaa </p>
...
\"><label class=''>mobile</label><br> 
   ...
   <tr style='border-bottom:none !important;'> <td > <div style='display:;margin-left: 12px;'><label class=''>address  (khasab maahan)</label><br> 
