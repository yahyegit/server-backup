...
<table class='table'><tr>
 ...
 <td><label>Recovery Email</label>	<input type='hidden' name='crf_code'  value='".get_unique_code()."'> 

 <input type='email'  placeholder='Email' name='email' value='".mysqli_result_(mysqli_query_("SELECT `email` FROM `settings` LIMIT 1"), 0)."' error_empty_msg='recovery email is required !' required> <p id='error_line' class=' hide'></p> 
 </td></tr></table>
