...
<td class='c_info' style='display:none;'> <label class=' float_label'>mobile <i>(optional)</i></label> <br> 
 ...
 <td><label class=''>Quantity  </label><br>	<input   type='number' error_empty_msg='required' onkeyup=\"update_bl_item($(this).closest('tr'))\" placeholder='Quantity' onchange=\"update_bl_item()\"  name='quantity' value='' required>      </td>  </td>  
...
<td> <label class='show_'>Total cost</label><br> 
  $ccc<input type='number' name='balance' value=''  error_empty_msg='required'  style='display:;border-left:none;' > 
 </td>

 <td> 
 <label class=''>Paid <i>(optional)</i></label><br> 
 $ccc<input type='number'  name='amount' placeholder=\"  paid (optional)\" value=''   style='display:; border-left:none; ' > </div>
 </td> 
