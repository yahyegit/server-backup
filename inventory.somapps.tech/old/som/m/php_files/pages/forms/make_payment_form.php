...
\"><label class=''> Discount <i>(khasab maahan)</i></label><br> 
   $ccc<input type='number' onchange='display_balance_calc();'  onkeyup='display_balance_calc();' name='discount' placeholder=\"   Discount (khasab maahan)   \" value=''  style='display:;' > </div>
  </td></tr>
...
\"><label>Description <i>(khasab maahan)</i></label><br>  <textarea id='description' name='description' placeholder='Description is not required ' style='border: 2px groove;border-radius: 0.5em;margin: 3.99306px 0px;width: 500px;height: 85px;'  ></textarea>  
</div>
      </td>
</tr> 
