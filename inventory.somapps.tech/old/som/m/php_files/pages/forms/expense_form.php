 ...
 function expense__auto()
  {


    $parts = array();
    $qq = mysqli_query_("SELECT DISTINCT `name` from expenses where delete_status !='1'");
...
\"><label class=''>cost</label><br> 
   $ccc<input type='number'  error_empty_msg='required'  required name='cost' placeholder=\"enter cost \" value='{$data['cost']}'  style='display:;' > </div>
  </td>
</tr>
...
\"><label>Description <i>(khasab maahan)</i></label><br>  <textarea id='description' name='description' placeholder='Description is not required ' style='border: 2px groove;border-radius: 0.5em;margin: 3.99306px 0px;width: 500px;height: 85px;'  >{$data['description']}</textarea>  
</div>
      </td> 
  </tr>   </table>
