...
'>   <p class=\"gray \" onclick=\"get_template.customers('','all_customers','pages/other_pages/expenses.php');\"> Expenses </p>  ";
     ...
     $ddd .= " <p  class='gray' onclick=\" get_template.reports( {date_from:'latest'},'pages/other_pages/reports_page.php'); \" > Reports   </p>  <p class='gray'  #view\"  onclick=\"get_template.customers('','all_customers','pages/other_pages/items.php');\"   > Alaabta  </p> <p  class='gray'  onclick=\"get_template.customers('','all_customers','pages/other_pages/users.php');\"> staffs   </p>";
    }
