...
<table class='table' style='    margin-left: 0px;width:auto !important; box-shadow: none !important;'>
   ...
   <input type='text' error_empty_msg='required' required name='item_name' placeholder=\"item\" value='$name'     > 
     ...
     <td> <div  style=\"
    margin-left: 12px;  
\"><label class=''>Inta iibinaysid <i>(price)</i></label><br> 
   $ccc<input type='number'  error_empty_msg='required'  required name='price' placeholder=\"Inta iibinaysid (price) \" value='$price'  style='display:;' > </div>
  </td>
