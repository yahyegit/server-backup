...
<button  class='change ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-primary' onclick=\"r_page('','','pages/forms/sale_items.php');\" role='button' aria-disabled='false' style=' display:inline;'><span class='ui-button-icon-primary ui-icon ui-icon-plus '></span><span class='ui-button-text'>Waxiibi  </span></button> 
...
<div class='it'>  <ul>  <li> <a href='#all'> alaabta </a> </li><li> <a href='#finished'> alaabta dhamaatay  $daaa </a> </li> 


<li> <a href='#afinished'> alaabta dhamaanrabta  $daaa_ </a> </li> 
</ul>
