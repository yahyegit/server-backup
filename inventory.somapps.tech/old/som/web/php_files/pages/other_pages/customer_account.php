...
<div class='it_'>  <ul>  
          ...
          <li> <a href='#items'>  items for <b>{$aRow['customer_name']}</b> </a> </li> 
...
<div id='items'>
 <table  class='table dataTable'  other_query=\" customer_id='$id'  \"  
 table_file='php_files/pages/server-side-tables/customer_items.php' >
<thead> <tr> 
                 <th>    </th>  </tr> </thead>
<tbody>
 </tbody></table>
...
<p class='title_'> dhaqdhaqaaqa <b> {$aRow['customer_name']} </b></p>
