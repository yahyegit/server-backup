...
<button  class='change ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-primary' onclick=\"r_page('','','pages/forms/sale_items.php');\" role='button' aria-disabled='false' style='  display:inline;/* float:left; */margin-bottom: -104px;position:;right:;  '  ><span class='ui-button-icon-primary ui-icon ui-icon-plus '></span><span class='ui-button-text'>waxiibi </span></button> 
...
<p class='title_' style='$da_'>
 ...
 <table  class='table dataTable'  style='$da'  other_query=\" customer_name!='' \"   table_file='php_files/pages/server-side-tables/customers.php' ><thead> <tr> 
                 <th> name  </th> <th>  mobile </th><th> balance </th> <th> invoices </th>  <th> address </th>    <th> action </th> 
               </tr> </thead>
<tbody>
 </tbody></table>
