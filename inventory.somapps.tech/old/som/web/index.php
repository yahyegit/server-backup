...
">
     <li class="overdue_li"> <a href="#view"  onclick="get_template.customers('','all_customers','pages/other_pages/remainder.php');"> Home <span class="spg"></span> </a></li>
      ...
      <li><a href="#view" class=""  onclick="get_template.customers('','all_customers','pages/other_pages/customers.php');"> Macaamiisha </a></li>    
     <li><a href="#view" class=""  onclick="get_template.customers('','all_customers','pages/other_pages/debts.php');"> Daymaha </a></li>
    ...
    <?php       if (is_admin($current_user)) {
     echo " <li> <a href=\"#view\"  onclick=\" get_template.reports( {date_from:'latest'},'pages/other_pages/reports_page.php'); \"> Reports  </a></li>  <li> <a href=\"#view\"  onclick=\"get_template.customers('','all_customers','pages/other_pages/items.php');\"> Alaabta</a></li> <li>  <a href=\"#view\"  onclick=\"get_template.customers('','all_customers','pages/other_pages/users.php');\"> staffs  </a></li>";
    }
...
<button  class='change ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-primary' onclick="r_page('','','pages/forms/sale_items.php');" role='button' aria-disabled='false' style=' display:inline;'><span class='ui-button-icon-primary ui-icon ui-icon- '></span><span class='ui-button-text'> Wax iibi </span></button> 
