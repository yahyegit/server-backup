...
global $ccc;
  ...
  $user_query = mysqli_query_("select * from suppliers where id='$customer_id' and delete_status!='1' ");
...
<p class='title_' style='".((!empty($customer_id))?'display:none;':'')."'> Adding new Customer  </p>
 
<table class='table' style='    margin-left: 0px;width:auto !important; box-shadow: none !important;'>

   <tr style='border-bottom:none !important;'> <td > <div style='display:;margin-left: 12px;'><label class=''>supplier </label><br> 
 
   <input type='text' error_empty_msg='required' required name='s_name' placeholder=\"supplier \" value='{$data['s_name']}'     > 
  </div></td>
...
<a href='#'  file_name=\"php_files/clasess/edit_sup_class.php\" class=\"submit_btn change ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-primary\" role=\"button\" aria-disabled=\"false\"><span class=\"ui-button-icon-primary ui-icon\"></span><span class=\"ui-button-text\">".((!empty($data['id']))?'Update':'Submit')."</span></a>
