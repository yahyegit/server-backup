  ...
  if(check_token($data['crf_code'],'check')){
               ...
               $data['amount'] = str_replace(',','',$data['amount']);
                 $data['date'] = date('Y-m-d');
                     ...
                     mysqli_query_("INSERT INTO `s_payments`(`s_id`, `paid`, `date`, `description`,`discount`)   VALUES ('{$data['id']}','{$data['amount']}','{$data['date']}','{$data['description']}','{$data['discount']}')");
