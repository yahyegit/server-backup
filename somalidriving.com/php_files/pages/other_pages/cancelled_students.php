<?php
 ...
 function students(){ // y,m,d
    ...
    $qq = mysqli_query_(" select * from students where active='0' and delete_status!='1' order by id DESC");
...
$data = "<div class='reports_page'>
  ...
  <h4 class='title_'> (".number_format(mysqli_result_(mysqli_query_("select count(id) from students where delete_status!='1' and active='0' 	") )).") Cancelled students  </h4>
