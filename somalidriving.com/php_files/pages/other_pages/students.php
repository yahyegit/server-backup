<?php
 ...
 function students(){ // y,m,d
    ...
    $qq = mysqli_query_(" select * from students where active='1' and delete_status!='1'   order by id DESC ");
       ...
       while($aRow = mysqli_fetch_assoc_($qq))
         {
            ...
            $students_grid .= " <div>
                   ...
                   data =  {id:$id_cust,active:'0'};
                    ...
                    \" role='button' aria-disabled='false' style=' display:inline;'><span class='ui-button-icon-primary ui-icon ui-icon-pencil'></span><span class='ui-button-text'> cancel </span></button> 
...
$data = "<div class='reports_page'>
  ...
  <h4 class='title_'> (".number_format(mysqli_result_(mysqli_query_("select count(id) from students where delete_status!='1' and active='1' 	") )).") Approved students  </h4>
