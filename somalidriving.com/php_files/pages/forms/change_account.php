<?php
 ...
 function get_company_account_form(){
...
<table class='table'><tr>
 ...
 <td><label>Account No</label><br>	<input type='hidden' name='crf_code'  value='".get_unique_code()."'> <input type='text' placeholder='Company Name' name='account' value='".mysqli_result_(mysqli_query_("SELECT `account` FROM `settings` LIMIT 1"), 0)."' required>  </td></tr></table>
