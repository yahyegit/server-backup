<?php
 ...
 function get_company_mobile_form(){
...
<table class='table'><tr>
 ...
 <td><label>Company Mobile</label><br>	<input type='hidden' name='crf_code'  value='".get_unique_code()."'> <input type='text' placeholder='Company Name' name='mobile' value='".mysqli_result_(mysqli_query_("SELECT `mobile` FROM `settings` LIMIT 1"), 0)."' required>  </td></tr></table>
