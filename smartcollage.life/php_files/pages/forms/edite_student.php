...
<tr>
  <td><label class='float_label show_'> Gender </label>

  <select error_empty_msg='required' name='gender' >   <option>..</option> <option ".((strtolower($data['gender']) =='male')?'selected="selected"':'').">male</option>
  <option ".((strtolower($data['gender']) =='female')?'selected="selected"':'').">female</option>
   </select>
