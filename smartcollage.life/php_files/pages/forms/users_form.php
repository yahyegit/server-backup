...
$('input[name=password]').attr('disabled','disabled'); 
 ...
 <tr style='border-bottom:none !important;'> <td > <div style='display:;margin-left: 12px;'><label class=''> user type </label>  
  
        <select error_empty_msg='required' name='type' > 
           <option> .. </option>
          <option  ".((strtolower($data['type']) =='staff')?'selected="selected"':'')." > staff </option>
          <option ".((strtolower($data['type']) =='admin')?'selected="selected"':'')." > admin </option>
        </select>
