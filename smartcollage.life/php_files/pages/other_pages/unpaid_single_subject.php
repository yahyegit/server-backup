...
<p><label class=\"show_ float_label\"> Total class balance </label> <b class='debt_color'>$".number_format(mysqli_result_(mysqli_query_(" select sum(balance) from  invoices where student_subject='$subject' and status='1' and balance!='0' and delete_status!='1' "), 0),2)."</b> </p>
