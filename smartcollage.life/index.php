...
">
     ...
     <li><a href="#view" class=""  onclick="get_template.customers('','all_customers','pages/other_pages/all_students.php');"> All Students </a></li>
 ...
 echo "  <li><a href=\"#view\" class=\"\"  onclick=\"get_template.customers('','all_customers','pages/other_pages/subjects.php');\"> Subjects </a></li>
  ...
  <li> <a href=\"#view\"   onclick=\"request_template('','','pages/other_pages/reports_page.php'); \"> Incomes </a></li>
