...
<table class='table'><tr>
 ...
 <td><label>college name</label><br>	<input type='hidden' name='crf_code'  value='".get_unique_code()."'> <input type='text' placeholder='Company Name' name='company_name' value='".mysqli_result_(mysqli_query_("SELECT `company_name` FROM `settings` LIMIT 1"), 0)."' required>  </td></tr></table>
