...
global $ccc;
   ...
   $customer_name = mysqli_result_(mysqli_query_("select s_name from suppliers where id='$customer_id' and delete_status!='1'"),0); 
        
   $data['balance'] =  mysqli_result_(mysqli_query_("select current_balance from suppliers where delete_status!='1' and id='$customer_id' "),0);
 return "
...
<h4 class='title_'> Making payment for supplier <strong> $customer_name </strong> . </h4>
...
<a href='#'  file_name=\"php_files/clasess/make_payment_supp_class.php\" class=\"submit_btn change ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-primary\" role=\"button\" aria-disabled=\"false\"><span class=\"ui-button-icon-primary ui-icon\"></span><span class=\"ui-button-text\">Submit</span></a>
