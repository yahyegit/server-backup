...
<td> <label class='show_'>Total cost</label><br> 
 ...
 <label class=''>Paid <i>(optional)</i></label><br> 
   $ccc<input type='number' onkeyup='currentTotalCost()' onchange='currentTotalCost()' name='amount' placeholder=\"  paid (optional)\" value=''   style='display:; border-left:none; ' > </div>
  </td> <td> <div  style=\"
    margin-left: 12px;    margin-top: 7px;

\"><label class=''>discount<i>(optional)</i></label><br> 
   $ccc<input type='number' onkeyup='currentTotalCost()'   onchange='currentTotalCost()'   name='discount' placeholder=\" discount (optional)\" value=''   style='display:; border-left:none; ' >  
  </td>
