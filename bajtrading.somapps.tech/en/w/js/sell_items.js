	...
	if($('.receive_form').is(':visible')){
		...
		return false;
			...
			$('input[name="price"]').each(function(){
                    ...
                    price_t =  clean($(this).closest('tr').find("input[name='price']:first").attr('price'))*quantity;
//console.log(price_t);
//console.log('single:w '+ $(this).closest('tr').find("input[name='price']:first").attr('price'));
 ...
 function currentTotalCost(){
	...
	$('input[name="cost"]').each(function(){
			...
			quantity = clean($(this).closest('tr').find("input[name='quantity']:first").val());
			cost_t =  clean($(this).closest('tr').find("input[name='cost']:first").val())*quantity;
// console.log(cost_t);
 //console.log('single:w '+ $(this).closest('tr').find("input[name='cost']:first").attr('cost'));
			cost = cost+cost_t; // cost+(cost_t*quantity);
