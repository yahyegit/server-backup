...
\"><label class=''>mobile</label><br> 
   ...
   <tr style='border-bottom:none !important;'> <td > <div style='display:;margin-left: 12px;'><label class=''>address  (optional)</label><br> 
 
   <input type='text'  name='address' placeholder=\"address  (optional)\" value='{$data['address']}'     > 
  </div></td>
   
    <td> <div  style=\"
    margin-left: 12px;  
\"><label class=''>email (optional) </label><br> 
   <input type='email'   name='email' placeholder=\"email (optional)\" value='{$data['mobile']}'  style='display:;' > </div>
  </td>
