...
<div class='it_'>  <ul>  
          ...
          <li> <a href='#items'>  invoices for {$aRow['customer_name']} </a> </li> 
          <li> <a href='#pending_invoices'> pending invoices for {$aRow['customer_name']}</a> </li> 
           <li> <a href='#payments'> payment history for {$aRow['customer_name']}</a> </li> 
      </ul>
