...
<div id="register_feadback" class="th_new" style="     box-shadow: rgba(46, 61, 73, 0.2) 5px 5px 25px 0px !important;
 margin-bottom: 27px;float: right;width: 72%;box-shadow: rgba(46, 61, 73, 0.2) 5px 5px 25px 0px !importan
t;font-weight: normal !important;color: rgba(128, 80, 162, 0.77);font-family: Arial, Helvetica, sans-serif;font-size: 18px;padding: 8px;/* margin: 0px; */
 background: #fff;">
 

   <a href="#" onclick="$('.th_new').hide();" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-icon-only ui-dialog-titlebar-close" role
="button" aria-disabled="false" title="close" style="
   float: right;
   height: 23px;
"><span class="ui-button-icon-primary ui-icon ui-icon-closethick">close</span><p id="error_line" class="hide"></p><span class="ui-button-text">close</span
></a>



System ka cusub free kutijaabi <b>Forex</b> buuleyahay <b>Lacagkastana</b> waad kumaamulikartaa.

<a href="http://forex.kunkeen.cash" style="
    margin-left: 1%; font-size: 13px;
" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-primary" onclick="window.location.href = 'http://forex.kunkeen.cash';" rol
e="button" aria-disabled="false" title="let's try"><span class="ui-button-icon-primary ui-icon ui-icon"></span><span class="ui-button-text"> Try now</span
></a>
...
echo "
 <i>language:</i> <select remove_filter=\"true\"  onchange=\"request_template('',{lang:$(this).find('option:selected').attr('name')},'clasess/change_lang.php');\"><option name='som' ".(($lang == 'som')?'selected=selected':'')." >Somali</option>
<option name='en' ".(($lang == 'en')?'selected=selected':'').">English</option>
...
">
    <ul>
     <li><a href="#view"  onclick="get_template.customers('','all_customers','pages/other_pages/all_customers_page.php');"> macaamiisha </a></li>
     <li> <a href="#view"  onclick="get_template.customers('','debts','pages/other_pages/debts_page.php');"> daymaha </a></li>
     <li><a href="#view"  onclick="get_template.customers('','credits','pages/other_pages/credits_page.php');"> Credits</a></li>
     <li><a href="#view"  onclick="get_template.reports( {date_from:'latest'},'pages/other_pages/reports_page.php');">xisaab xirka</a></li>
