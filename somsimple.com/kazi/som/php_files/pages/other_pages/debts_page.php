...
function get_debt_customers(){
  ...
  return "<h3 class='title_'>(".number_format(mysqli_result_(mysqli_query_("select count(customer_id) from customers where  customer_name !='' and current_ksh_balance LIKE '-%' OR current_dollar_balance LIKE '-%'  and delete_status!='1'"),0)).") macaamill baa dayn laguleeyahay </h3>   
