...
'> <input type='date' id='date_from' customer_id='$customer_id'  value=\"{$data['date_from']}\"  onchange=\"chosen_cust_report_date();\" >  
 ...
 <table class='table' style='
    ...
    margin-top: 20px;
    /* margin-left: 0px; */
'><thead><tr> <th class='title_2'> Totalka xisaabadka ee {$cust_info['customer_name']}  <i>($full_date)</i> </th> </tr><tr></tr></thead>
<tbody>
  <tr> <td style='
    background: #fafbfc;
'>
...
<h3 class=\"title_\"  >($trans_length) xisaabood ee {$cust_info['customer_name']} <i>($full_date)</i>  </h3> <table class=\"table dataTable\"   table_file='php_files/pages/server-side-tables/transactions_history.php' other_query2=\"$other_query_2\"  other_query=\"$other_query_\" primary_key='id'  >
