...
t;font-weight: normal !important;color: rgba(128, 80, 162, 0.77);font-family: Arial, Helvetica, sans-serif;font-size: 18px;padding: 8px;/* mar
gin: 0px; */
 background: #fff;">
 

   <a href="#" onclick="$('.th_new').hide();" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-icon-only ui-dialog-titlebar
-close" role
="button" aria-disabled="false" title="close" style="
   float: right;
   height: 23px;
"><span class="ui-button-icon-primary ui-icon ui-icon-closethick">close</span><p id="error_line" class="hide"></p><span class="ui-button-text"
>close</span
></a>
...
" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-primary" onclick="window.location.href = 'http://forex.kunkeen
.cash';" rol
e="button" aria-disabled="false" title="let's try"><span class="ui-button-icon-primary ui-icon ui-icon"></span><span class="ui-button-text"> T
ry now</span
></a>
