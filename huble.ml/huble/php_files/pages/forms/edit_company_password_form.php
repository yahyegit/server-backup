...
<th>current password</th>
 <td>	
   <input type='password' name='current_password' error_empty_msg='password is required !' required> <p id='error_line' class=' hide'></p> </td> </tr>
<tr>
 <th>new password</th>
 <td>  

 <input type='password' name='password_new' id='newPass'  error_empty_msg='password is required !' required>  <p id='error_line' class=' hide'></p>
</td></tr>
...
<th>confirm password</th>
 <td>	
   <input type='password' pw_confirm='#newPass' error_empty_msg='password is required !' required><p id='error_line' class=' hide'></p> </td> </tr>
