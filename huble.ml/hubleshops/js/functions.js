...
function chosen_report_date(){
	...
	to_date = $("input#date_to").val();
	 ...
	 get_template.reports({date_to:to_date,date_from:from_date},'pages/other_pages/reports_page.php');
...
function error_func(msg){
	...
	if($('form').is(':visible')){
  	...
  	$('div#error').html('<img src="css/error.jpg" alt="error" style="border-radius:2em; width:60px; height:40px; margin-right: 4px;"/>'+msg).fadeIn(); 
