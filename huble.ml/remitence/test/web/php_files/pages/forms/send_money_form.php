...
$names = get_names();
     ...
     $id = sanitize($data['id']);
   $data = mysqli_fetch_assoc_(mysqli_query_("SELECT `id`, `sender_id_no`, `sender_name`, `sender_mobile`, `pay_to_name`, `pay_to_mobile`, `delete_status`, `description`, `amount`,`status`, `pay_to_id`, `user_id`,`commission` FROM `payments` WHERE id='$id' and delete_status!='1'")); 
