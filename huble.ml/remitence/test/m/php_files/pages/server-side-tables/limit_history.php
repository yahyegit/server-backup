 ...
 <?php
	...
	$aColumns = explode(",",'send_amount,id,amount,user_id,description,date');
...
$mo_ = "<p><label class='show_ float_label'> payment limit:</label> $".number_format($aRow['amount'],2)."</p> ";

$mo_ .= "<p><label class='show_ float_label'> sending limit:</label> $".number_format($aRow['send_amount'],2)."</p> ";
