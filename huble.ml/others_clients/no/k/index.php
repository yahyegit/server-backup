...
<title> Exchange System v2.0.1 </title>
...
<input type="button" class="button" value="Log Out" id="logout" />
  ...
  <!-- cosomers table -->
    ...
    <div  id="castomer_details">
          ...
          <div id="worning_to_delete" title="Worning"  style="display:none;">  <p class="error" id="error3" style="display:none;"  >  </p> Are you sure want to delete This person </div>
          ...
          <div id="add_div" style="display:none;" title="Add New Custom">
           ...
           <span class="error" id="error" style="display:none;"  >  </span>
              ...
              <table class="table" style=" width: 700px; margin-left: 0; margin-top: 7px; ">
                           <tr><th> Number </th> <th> Description </th>  <th> ID/Passport </th></tr> 
                     <tr> <td> <input type="text" class="input" style="color:red;"  id="new_number" value=""/> </td><td> <input type="text" class="input" size="35"  style="color:red;"  id="description"   > </td>  <td> <input type="text" class="input" size="35"  style="color:red;"  id="id_or_passport"   > </td></tr>
               </table>
          ...
          <div id="edit_div" style="display:none;" title="Update"> 
              ...
              <table class="table" style=" width: 700px; margin-left: 0; margin-top: 7px; " >
                           <tr><th> Number </th> <th> Description </th> <th> ID/Passport </th></tr> 
                     <tr> <td> <input type="text" class="input" style=" color:red;"  id="edit_number" value=""/> </td><td>  <input type="text" class="input" size="35"style=" color:red;"  id="description2" value=""/> </td> <td> <input type="text" class="input" size="35"  style="color:red;"  id="id_or_passport_edit"   > </td></tr> 
               </table>  
          ...
          <div id="new_exp_div" style="display:none;" title="new oppen day">
            ...
            <span class="error" id="error_exp2" style="display:none;" >  </span>
                ...
                <table class="table">
                  ...
                  <tr> <th>Title</th><th> Cash In </th><th> Cash Out </th> <th> Cash balance </th> <th> Dollar In </th> <th> Dollar Out </th> <th> Dollar balance </th> </tr> 
                  ...
                  <tr>
                    ...
                    <td><input type="text" id="cashout_exp" class="input" style="width:100px; color:red;"  value="" />  </td>
                  ...
                  <td>$<input type="text" class="input" style="width:100px; color:red;" id="dollout_exp"/></td>
          ...
          <div id="edit_exp_div" style="display:none;" title="Edit day">
            ...
            <span class="error" id="error_exp" style="display:none;" >  </span>
                ...
                <table class="table">
                  ...
                  <tr> <th>Name</th><th> Cash In </th><th> Cash Out </th> <th> Cash balance </th> <th> Dollar In </th> <th> Dollar Out </th> <th> Dollar balance </th> </tr> 
                  ...
                  <tr>
                    ...
                    <td><input type="text" id="cashout_expx" class="input" style="width:100px; color:red;"  value="" />  </td>
                  ...
                  <td>$<input type="text" class="input" style="width:100px; color:red;" id="dollout_expx"/></td>
      ...
      <div id="expence_bage">
          ...
          <a href="#" id="new_exp" class="buttons add">ADD</a>

          <a href="#" id="new_exp_costom" class="buttons add">ADD</a>
          ...
          <div id="new_exp_div2" style="display:none;" title="new costom day">

          

        <span class="error" id="error_exp3" style="display:none;" >  </span>
                ...
                <table class="table">
                  ...
                  <tr> <th>Name</th><th> Cash In </th><th> Cash Out </th> <th> Blance </th> <th> Doller In </th> <th> Doller Out </th> <th> Doller Blance </th>  <th> Number </th> </tr> 

                  <tr>

                    <td><input type="text" id="name_exp2" class="input" value=""/> </td>

                    <td><input type="text" class="input" style="width:100px; color:red;" id="cashin_exp2"/></td>

                    <td><input type="text" id="cashout_exp2" class="input" style="width:100px; color:red;"  value="" />  </td>

                     <td> <span class="input" style=" background:#fff; color:red;" id="show_blance_cash2" >0</span>  </td>

                  

                  <td>$<input type="text" class="input" style="width:100px; color:red;" id="dollin_exp2"/></td>

                  <td>$<input type="text" class="input" style="width:100px; color:red;" id="dollout_exp2"/></td>

                 <td>$<span class="input" style=" background:#fff; color:red;" id="show_blance_doller2" >0</span> </td>

                  <td><input type="text" class="input" style="width:100px; color:red;" id="number_exp"/></td>
      ...
      <div id="settings_bage">
            ...
            <a href="#" id="change_user" class="button edit">change </a>
            ...
            <a href="#" id="change_passw" class="button edit" >change </a>
            ...
            <label id="label"> Allow multiple users:</label>   <b id="protection"></b>

            <a href="#" id="change_prot" class="button edit" > change </a>
...
<div id="containter" class="coppyRight" style=" width: 580px; font: bold 15px italic; text-align: center; color: #fff; margin-left: 18%; padding: 10px; background: #000000;border-radius: 7px;-moz-border-radius: 7px;-webkit-border-radius: 7px;box-shadow: 10px 10px 15px #A0A0A0;-moz-box-shadow: 5px 5px 15px #A0A0A0;-webkit-box-shadow: 5px 5px 15px #A0A0A0; /* height: 600px; */ /* overflow-x: auto; */}* {margin: 0px;padding: 0px;list-style-type: none; ;margin-top: 0; margin-bottom : 1;" > Developed by: Yahye  (+97158-897-6050) </div>
<span href="#" onclick="$('.coppyRight').toggle();"> || </span>  
...
<noscript>
<a href="https://www.livechatinc.com/chat-with/11307762/" rel="nofollow">Chat with us</a>,
