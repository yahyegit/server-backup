	...
	function search(){	
	 ...
	 $('#castomer_details2').html('<img src="loading.gif" alt="loadin..."/> ').fadeIn();
			 ...
			 location.reload();
				...
				$('#castomer_details2').fadeOut().html(data).fadeIn();	
				...
				$('#worning_to_delete').dialog({ position:'top',buttons:{'YES': function (){
					...
					$.post('delete.php',{ id_del: id_del}, function (deleted) {
							...
							if (deleted == 1){
									...
									$('#Deleted').html('<img src="success.gif" style="border-radius:6em"><p style="color: #fff;"><strong>'+magec2+'</strong>  has been Deleted!</p>').dialog({ position:'top',buttons:{'Okay': function (){
