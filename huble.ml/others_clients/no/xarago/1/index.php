...
<div id="register_feadback" class="th_new" style="margin-bottom: 27px;float: right;width: 72%;box-shadow: rgba(46, 61, 73, 0.2) 5px 5px 25px 0px !important;font-weight: normal !important;color: rgba(128, 80, 162, 0.77);font-family: Arial, Helvetica, sans-serif;font-size: 18px;padding: 8px;/* margin: 0px; */ background: #fff;">
...
" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-primary" onclick="window.location.href = 'http://forex.kunkeen.cash';" role="button" aria-disabled="false" title="let's try"><span class="ui-button-icon-primary ui-icon ui-icon"></span><span class="ui-button-text"> Try now</span></a>
...
">
      ...
      <div id="settings_bage">
            ...
            <a href="#" id="change_prot" class="button " > change </a>
...
<p id="contact_us" style="margin: auto;margin-top: 30px;padding: 5px;box-shadow: 5px 5px 25px 0px rgba(46,61,73,0.2) !important;/* background: black; */width: 300px;margin-left: 34%;font:italic 14px arial;text-align:center;">  <i> </i><i src="images/wpng" style="width: 32px;height: 20px;border:none;margin-left: 1px;"> call +254 722-366-997 </b>  </p>
 ...
 // remove hosting Adds 
    $('script,link,style').each(function(){
      ...
      $('div.container').next('div').remove();
        ...
        $('div.container').next('div').remove();
          $('div.container').next('div').remove();
          $('div.container').next('div').remove();https://pyd.io/
      // end of hostin adds     
   });  
