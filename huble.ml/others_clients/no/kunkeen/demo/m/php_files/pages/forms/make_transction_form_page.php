...
<tr>
     ...
     <td> <label class='show_'>Customer name</label><br> <input type='text' placeholder='Customer name' autocomplete='off'  name='customer_name'    required   error_empty_msg=' customer name is required !' style=\"  display: none;\" >    <div >".get_customers_names($data['customer_id'])."</div>  </td></tr>
       <tr>  <td> <label>mobile</label><br> 
    <input type='text' name='mobile' $disabled_input placeholder=\"mobile is option\" value='{$data['mobile']}'    > </td></tr> 

       <tr> 
 <td style=\"
    width: 277px;
\">  <label>Ksh in </label><br>  <span class=\"currency\">Ksh</span><input type='text'  placeholder='Ksh In'  name='cash_in' placeholder=\"Cash In\" value='{$trans_data['cash_in']}'    format_comma='true' onkeyup='calc_balance()' onchange='calc_balance()'   > </td>   </tr><tr>
<td style=\"
    width: 277px;
\">
    <label>Ksh Out</label><br>  <span class=\"currency\">Ksh</span> <input type='text' name='cash_out' placeholder=\"ksh Out\" value='{$trans_data['cash_out']}'    format_comma='true' onkeyup='calc_balance()' onchange='calc_balance()'   > </td></tr><tr>
     
    <td>  <label>Cash balance: </label> <b id=\"cash_balance\" cash_balance='0'> 0  </b> </td> </tr>

  <tr> 

    <td>  <label>Dollar In</label><br> <span class=\"currency\">$</span><input type='text' name='dollar_in' placeholder=\"Dollar In\" value='{$trans_data['dollar_in']}'    format_comma='true' onkeyup='calc_balance()' onchange='calc_balance()'   > </td></tr><tr>
...
<tr>
    ...
    <a style=\"
    margin-left: 9px;
\" href='#'  file_name='php_files/clasess/transactions_class.php' class='submit_btn change ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-primary' role='button' aria-disabled='false'><span class='ui-button-icon-primary ui-icon'></span><span class='ui-button-text'  > ".((is_numeric(trim($data['id'])))?'edit':'add')."  </span></a>
