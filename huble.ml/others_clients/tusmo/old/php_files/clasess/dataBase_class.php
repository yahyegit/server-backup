...
$myServer = "mysqld.tusmo.info";
$myUser = "kunisii";  
$myPass = 'ssd[Vfs%^d456hfgKMa@tX[';
$myDB = "kunisii_demo_2";
...
// check login 
 functio if_logged_in($type){   // check,check with die(), login
...
return "<!DOCTYPE html>
                          ...
                          <head>
                            <title></title>
                            <script type='text/javascript'>window.location.href='https://www.tusmo.info/yassin/' </script>
                          </head>
                          <body>
