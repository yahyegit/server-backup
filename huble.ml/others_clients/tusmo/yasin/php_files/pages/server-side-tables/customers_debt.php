...
// th>name</th> <th>mobile</th> <th>Current Balance</th> <th> more </th><th>Action</th> 
	...
	$output = array(
		...
		"iTotalRecords" =>  get_count_customers('debt'),
 		"aaData" => array()
	);
	     ...
	     while($aRow = mysqli_fetch_assoc_($rResult))
			{
							  ...
							  include 'common2.php';
 		if((preg_match('/-/', $balance_ksh) == false && number_format($balance_ksh,2) !='0.00' ) || (preg_match('/-/', $balance_dollar) == false && number_format($balance_dollar,2) !='0.00')){
