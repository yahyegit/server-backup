<?php
 ...
 return "
<div class='form' id='com_moblie_form' action='#' style='margin:auto; width:40%' >
<input type='hidden' name='crf_code'  value='".get_unique_code()."'>
<table class='table'><tr>
 
 <td>	 <label>Mobile</label> </br> <input type='text' placeholder='mobile' name='mobile' value='".mysqli_result_(mysqli_query_("SELECT `mobile` FROM `settings` LIMIT 1"), 0)."' >  </td></tr></table>
