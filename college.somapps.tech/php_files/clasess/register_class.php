...
// connect to the MySQL server
    ...
    $company_name_db = str_replace(' ','',strtolower("college_".$company_name));
...
if ($connection->query($sql) === TRUE) {
        ...
        // import the sql file  
				...
				$query = '';
				$sqlScript = file('somschool_db.sql');
				foreach ($sqlScript as $line){
					...
					if ($endWith == ';') {
						...
						mysqli_query($connection,"update users set password='$password',full_name='$username', username='$username' where type='admin' limit 1");
					}
				}
