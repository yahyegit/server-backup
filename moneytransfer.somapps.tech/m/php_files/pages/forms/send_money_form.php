...
<table class='table' style='    margin-left: 0px;width:auto !important; box-shadow: none !important;'>
   ...
   <tr  > <td  class='csn' > <div style='display:;margin-left: 12px;'><label class=' '>sender name</label><br> 
 
 

   <input type='text' error_empty_msg='required'  required required name='sender_name' placeholder=\"Sender name \" value='{$data['sender_name']}'  style=\"display: ;\"  > 
  </div></td> </tr>
...
\"  value='{$data['sender_id_no']}'  > 
   ...
   <input type='text' error_empty_msg='required'  required required name='pay_to_name' placeholder=\"Receiver name\" value='{$data['pay_to_name']}'  autocomplete=\"off\" > 
  </div></td>  
 </tr>
<tr>
   ...
   <input type='text'  title='Enter full mobile with zip code to send the sms e.g: +252-61555-55-55'  error_empty_msg='required'  required required name='pay_to_mobile' placeholder=\"Receiver mobile \" value='{$data['pay_to_mobile']}'     > 
  </div></td>
...
<tr>
   ...
   $<input type='text' error_empty_msg='required'  ".((!ctype_digit($id))?' onkeyup="remaining_calc();" ':'')."     format_comma='true' required name='amount' placeholder=\" amount \" value='{$data['amount']}'     > 
  </div></td>
</tr>
