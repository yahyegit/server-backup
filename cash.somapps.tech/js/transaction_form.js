...
$('.t124 input').val('');
 ...
 $('.t124 .mu_td').html(" <label class='float_label show_'> choose </label><br>             <select remove_filter='true' onchange=\"auto_calc($(this).parents().closest('tr')); \"   class='rate_multi' onchange='  '><option> .. </option> <option> buy </option> <option> sale</option> </select>");
...
$('input[name="amount"]').attr('old_result_bl',0).attr('amount_2',0);
  ...
  $('.mu_td').html(" <label class='float_label show_'> choose </label><br>             <select remove_filter='true' onchange=\"auto_calc($(this).parents().closest('tr')); \"  class='rate_multi' onchange='  '><option> .. </option> <option> buy </option> <option> sale</option> </select>");
...
if(from_chosen == 'selected'){
  row_element.find('input[name="amount"]').val('');//.attr('old_result_bl','0').attr('amount_2','0');
        ...
        if($.trim(row_element.find('select.rate_multi').val()) == 'buy'){
         ...
         }else   if($.trim(row_element.find('select.rate_multi').val()) == 'sale'){
