<?php
 ...
 return "
  ...
  <form  id='customer_info_form' action='#' style=\"
    width: 45%;
    margin: auto;
\" >
...
<label>mobile</label>
 <input placeholder='mobile' type='text' name='mobile' value='".mysqli_result_(mysqli_query_("SELECT `mobile` FROM `customers` where customer_id={$cust_id['id']} "), 0)."'  >  </td>
