...
function get_debt_customers(){
  ...
  return "<h3 class='title_'>(".get_credit_debt('debt')['len'].") Customers in debt </h3>   
...
'>
 ...
 <table  class='table dataTable' table_file='php_files/pages/server-side-tables/customers_debt.php' ><thead><tr> <th>Name</th> <th>Mobile</th>  <th> Current Balance </th><th  class='hide_for_print'> more </th><th class='hide_for_print'>Action</th></tr></thead>
<tbody>
 </tbody></table>
