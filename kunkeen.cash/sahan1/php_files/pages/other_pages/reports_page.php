...
<table class='table grid_1 c_ac_page' > <thead><tr><th>Total In </th> <th> Total Out </th><th> Balance </th></tr></thead><tbody>  <tr>
<td> ".get_totals_($pro_,'in')." </td> <td> ".get_totals_($pro_,'out')." </td> <td> ".get_totals_($pro_,'bl')."  </td> 
  </tr></tbody></table>
