...
<table class='table' style='    margin-left: 0px;width:auto !important; box-shadow: none !important;'>
   ...
   <input type='text'   required name='name' placeholder=\"name \" value='{$data['name']}' disabled='disabed'  > 
  </div></td>
...
\"><label class=''>Paid</label><br> 
   <input type='text' format_comma='true'  onkeyup='update_balance2();' name='paid' placeholder=\"enter paid or set remainder \" value=''  style='display:;' > </div>
  </td>
</tr>
...
\"><label class='show_'>debt remainder  <i>(optional)</i></label><br> 
     <input type='date' name='due_date' value='{$data['due_date']}'   style=' ' > </div>
    </td>
</tr> 
