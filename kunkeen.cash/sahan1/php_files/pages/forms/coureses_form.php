...
<table class='table' style='    margin-left: 0px;width:auto !important; box-shadow: none !important;'>
   ...
   <input type='text' error_empty_msg='required'  required title='Enter course' required name='course' placeholder=\"name \" value='{$data['course']}'     > 
  </div></td>
...
\"><label class=''>cost</label><br> 
   ...
   <input type='text' error_empty_msg='required'  required title='Enter duration' required name='duration' placeholder=\"name \" value='{$data['duration']}'     > 
  </div></td>
...
<a href='#'  file_name=\"php_files/clasess/courses_class.php\" class=\"submit_btn change ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-primary\" role=\"button\" aria-disabled=\"false\"><span class=\"ui-button-icon-primary ui-icon\"></span><span class=\"ui-button-text\">".((!empty($data['id']))?'Update':'Submit')."</span></a>
