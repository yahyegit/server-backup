 ...
 <?php
	...
	$aColumns = explode(",",'id,name,courses,mobile,date,balance,address,due_date,description');
	$sIndexColumn =  'id';  
 	$other_query = "balance !='0' and due_date!='0000-00-00' and due_date<='".date('Y-m-d')."'";  
 	 	$sTable =  'students';
