...
<html>
<head>
  <title> hi, <?php  echo $compan_name_;?> | KunkeenApp </title>
...
">
    ...
    height: 46px;
">
     <li class="overdue_li"> <a href="#view"  onclick="get_template.customers('','debts','pages/other_pages/overdue_page.php');"> overdue debt <span class="due_date_bg"></span> </a></li>
     <li><a href="#view" class="first_li"  onclick="get_template.customers('','all_customers','pages/other_pages/all_customers_page.php');"> Students </a></li>
     <li> <a href="#view"  onclick="get_template.customers('','debts','pages/other_pages/debts_page.php');"> Debts </a></li>
     <li> <a href="#view"   onclick="get_template.reports( {date_from:'latest'},'pages/other_pages/income_reports_page.php');"> Incomes </a></li>
     <li> <a href="#view"  onclick="get_template.reports( {date_from:'latest'},'pages/other_pages/expense_page.php');");" > Expenses </a></li>
    <li> <a href="#view"  onclick="get_template.customers('','debts','pages/other_pages/courses.php');"> courses </a></li>
