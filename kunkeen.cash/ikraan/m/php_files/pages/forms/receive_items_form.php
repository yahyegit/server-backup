...
<table class='table'>
 ...
 <td><label>quantity</label><br>	<input  title='hadii aad cabir ahaan ugadaysid sida mitir,kiilo, ama liter ahaan waxaad kuqortaa intuu yahay'  type='number' error_empty_msg='required' onkeyup=\"update_bl_item()\" placeholder='quantity' onchange=\"update_bl_item()\"  name='quantity' value='' required>      </td>  </td>     </tr>

 <tr><td><label>remainings</label><br> <input type='number'  placeholder='remainings' name='remainings' value='' disabled='disabled'  >      </td> </tr>

   <tr>
 <td><label>total cost</label><br>  $ccc<input type='number' error_empty_msg='required'  placeholder='cost' name='cost' value=''  required>  </td> </tr>


   <tr>   <td><label class='show_'>price</label><br>  $ccc<input type='number' error_empty_msg='required'  placeholder='price' name='price' value=''  required>  </td>  </tr>
...
<div class=\"form_footer_btns sing_no_mar \">   
